...
- **Boot e2e (modelo real):** o server carrega as 12 entidades, valida cada manifest contra a
...
3. **As 12 entidades são reais** do server (serviços rs 586, sc 208, sp 537, pr 141, mg 148, pe 38,
   ba 204, rj 91, ce 382, ms 276, mt 27, go 94; FAQs 1937 no RS), não só do frontend.
