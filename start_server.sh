#!/bin/bash
# start_server.sh — compila e sobe o servidor da Auli (workspace `auli-server`, modo `server`) em :3000.
...
WS="$ROOT/auli-server"                                          # workspace Cargo (vector-store/auli-core/auli-cli)
