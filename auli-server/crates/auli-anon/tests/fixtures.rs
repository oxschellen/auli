...
const FIXTURES: &[Fx] = &[
    ...
    Fx { id: "07", categoria: "Telefone celular", classe: Classe::Estruturado, coberto: false,
        pergunta: "Contribuinte pede contato no telefone (51) 99876-5432 para tratar do auto de lançamento.",
        segredos: &["(51) 99876-5432"] },
    Fx { id: "08", categoria: "Telefone fixo", classe: Classe::Estruturado, coberto: false,
    ...
    Fx { id: "11", categoria: "Número de GA", classe: Classe::Estruturado, coberto: false,
        pergunta: "A GA de número 0312026000987654 foi paga com código errado. Como pedir a alteração?",
        segredos: &["0312026000987654"] },
    Fx { id: "12", categoria: "RENAVAM", classe: Classe::Estruturado, coberto: false,
...
#[test]
#[ignore = "alvo da Fase 1: faltam reconhecedores (telefone, IE, protocolo, GA, RENAVAM, placa, CEP, data)"]
