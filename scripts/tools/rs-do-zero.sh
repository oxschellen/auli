...
main() {
  ...
  echo "Etapa 1/12 — 🗑️  apagando os caches de serviços e faqs"
  ...
  echo "Etapa 2/12 — 📂 entrando em auli-server/ (os passos seguintes resolvem data/ pelo CWD)"
  ...
  echo "Etapa 3/12 — 🧠 EMBED_CACHE_DIR=/home/ubu/Desktop/auli/models"
  ...
  echo "Etapa 4/12 — 🕸️  raspando faqs e serviços do portal (~2.500 páginas, tudo da rede)"
  ...
  echo "Etapa 5/12 — 🔨 compilando auli e auli-collections (release)"
  ...
  echo "Etapa 6/12 — 🌳 derivando os artefatos (árvores docs/faqs e docs/servicos)"
  ...
  echo "Etapa 7/12 — 📦 vetorizando os packs do RS (a demorada; confira a linha de reaproveitados)"
  ...
  echo "Etapa 8/12 — 🗂️  derivando o índice da aba de pareceres"
  ...
  echo "Etapa 9/12 — 🗂️  derivando o índice da aba do TARF"
  ...
  echo "Etapa 10/12 — 🔪 derrubando instância anterior do servidor, se houver"
  ...
  echo "Etapa 11/12 — ⚙️  AULI_DATA_DIR=/home/ubu/Desktop/auli/data, AULI_LOG_DIR=/home/ubu/Desktop/auli/logs"
  ...
  echo "Etapa 12/12 — 🚀 subindo a API em http://127.0.0.1:3000 — Ctrl+C para parar"
